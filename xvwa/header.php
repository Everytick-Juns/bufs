<link rel="icon" type="image/png" href="/bufs/xvwa/img/xvwa-logo-1.png" />
<div class="container">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="/bufs/xvwa/">XVWA</a>
    </div>
            ...
            <li class="dropdown" id="menuLogin">
                <?php
                    ...
                    if(isset($_SESSION['user'])){
                        ...
                        echo "<li><a href='".$XVWA_WEBROOT."/bufs/xvwa/logout.php'>Logout</a></li>";
                        echo "</ul>";
                    }else{
